...
<script type="text/javascript" src="/js/swiper.4.5.1.js"></script>
...
<!-- KKO MAP API JS 2022.05.23 -->
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=<?php echo _KKO_APP_JS_KEY ?>"></script>
	...
	<header id="header">				
		...
		<section>
			...
			<div class="side_menu pc_only_1024">
				<ul>
					<li onMouseOver='this.innerHTML="건물주 상담"' onMouseOut='this.innerHTML="Franchise"' onClick="location.href='/main/franchise.php'"><a href="javascript:;" >Franchise</a></li>
